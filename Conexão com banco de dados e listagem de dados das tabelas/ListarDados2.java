...
public class ListarDados2 {

    private static final String CONSULTAR_DADOS = "SELECT id, nome, sub_grupo FROM grupo_produto";
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Listagem de dados da tabela grupo_produto:");
